          ...
          <v-spacer></v-spacer>
            ...
            <v-tooltip top>
                <template v-slot:activator="{ on }">
                    <v-btn color="green" v-on="on" fab small dark @click="checkConnection">
  ...
  export default {
    ...
    methods: {
        ...
        async traffic(){
          ...
          try {
            const { data } = await this.axios.get('http://127.0.0.1:8001/trend/'+ this.$route.params.id +'?start_date=' + this.start_date + '&end_date=' + this.end_date + '&interval=' + this.interval_select.interval_id + '&lane=' + this.id_lane)
        ...
        async pie(){
          try {
            const { data } = await this.axios.get('http://127.0.0.1:8001/pie/'+ this.$route.params.id +'?start_date=' + this.start_date + '&end_date=' + this.end_date + '&lane=' + this.id_lane)
        ...
        videoStream(){
            ...
            this.videoDefault = "http://10.0.10.100:" + this.port + "/" + random + "/stream.mjpg"
        },
