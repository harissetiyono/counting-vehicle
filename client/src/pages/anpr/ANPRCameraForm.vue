    ...
    methods: {
        ...
        save(id){
            ...
            if (this.$v.$invalid) {
                ...
                if (id) {
                    this.axios.put(process.env.VUE_APP_IP_SERVER + '/camera', { camera_data : this.camera_data })
                }else{
                    this.axios.post(process.env.VUE_APP_IP_SERVER + '/camera', { camera_data : this.camera_data })
                }
                this.$router.push('/anpr/camera/')
            }
        },
